...
module.exports = [
  ...
  ['script', {}, `
    ...
    function ABDetected() {
      ...
      adBlockDetected_div.style.cssText = "position: fixed; top: 0; left: 0; width: 100%; background: #1890ff; color: #fff; z-index: 9999999999; font-size: 14px; text-align: center; line-height: 1.5; font-weight: bold; padding-top: 6px; padding-bottom: 6px;";
      ...
      adBlockDetected_close.style.cssText = "position: absolute; top: 0; right: 10px; width: 30px; height: 30px; background: #1890ff; color: #fff; z-index: 9999999999; line-height: 30px; cursor: pointer;";
